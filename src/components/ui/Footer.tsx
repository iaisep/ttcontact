        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/docs" className="hover:text-primary transition-colors">{t("documentation")}</Link></li>
              <li><Link to="/examples" className="hover:text-primary transition-colors">{t("examples")}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/careers" className="hover:text-primary transition-colors">{t("jobs")}</Link></li>
              <li><Link to="/press" className="hover:text-primary transition-colors">{t("press")}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/cookies" className="hover:text-primary transition-colors">{t("cookies")}</Link></li>
