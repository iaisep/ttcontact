  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-4">
      <div className="w-full grid grid-cols-3 gap-2">
        <Button variant="outline" onClick={handleAudioTest} className="w-full flex items-center justify-center " disabled={isLoading || isRecording}>
          <Phone className="mr-2 h-4 w-4" /> 
          {t('audio')}
        </Button>
        
        <Button variant="outline" onClick={handleLlmTest} className="w-full flex items-center justify-center " disabled={isLoading || isRecording}>
          <TestTube className="mr-2 h-4 w-4" /> 
          {t('llm')}
        </Button>
        
        <Button variant="outline" onClick={handleCodeTest} className="w-full flex items-center justify-center " disabled={isLoading || isRecording}>
