  ...
  return (
    <div className="w-full grid grid-cols-3 gap-1">
      <Button 
        variant="outline" 
        onClick={onAudioTest} 
        className="w-full flex items-center justify-center text-[10px] px-1" 
