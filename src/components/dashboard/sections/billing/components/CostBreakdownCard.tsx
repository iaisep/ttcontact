      ...
      <CardContent>
        <div className="border rounded-md divide-y">
          <div className={`${isMobile ? 'flex flex-col space-y-2' : 'flex justify-between'} py-3 px-4`}>
            ...
            <p className={`font-medium ${isMobile ? '' : 'text-right'}`}>{formatCurrency(usage?.voice_minutes ? usage.voice_minutes * 0.075 : 0)}</p>
          </div>
          ...
          <div className={`${isMobile ? 'flex flex-col space-y-2' : 'flex justify-between'} py-3 px-4`}>
            ...
            <p className={`font-medium ${isMobile ? '' : 'text-right'}`}>{formatCurrency(usage?.phone_numbers ? usage.phone_numbers * 1.0 : 0)}</p>
          </div>
          ...
          <div className={`${isMobile ? 'flex flex-col space-y-2' : 'flex justify-between'} py-3 px-4`}>
            ...
            <p className={`font-medium ${isMobile ? '' : 'text-right'}`}>{formatCurrency(usage?.api_calls ? usage.api_calls * 0.00001 : 0)}</p>
          </div>
          ...
          <div className={`${isMobile ? 'flex flex-col space-y-2' : 'flex justify-between'} py-3 px-4`}>
            ...
            <p className={`font-medium ${isMobile ? '' : 'text-right'}`}>{formatCurrency(49.99)}</p>
          </div>
