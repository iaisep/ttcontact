...
import WhatsAppInboxForm from './WhatsAppInboxForm';
...
type ModalView = 'channel-selection' | 'whatsapp-form' | 'telegram-form' | 'website-form';
...
const AddInboxModal: React.FC<AddInboxModalProps> = ({
  ...
  const [currentView, setCurrentView] = useState<ModalView>('channel-selection');
